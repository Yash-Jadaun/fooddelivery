...
export default function Card() {
    return (
        <div>
            ...
            <div className="card mt-3" style={{ width: "18rem", maxHeight: "360px" }}>
                <img src="https://img.freepik.com/premium-photo/hamburger-with-cheese-cutlet-salad-tomato-sauce-french-fries_252187-3092.jpg" className="card-img-top" alt="Hamburger" />
                <div className="card-body">
